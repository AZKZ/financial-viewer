...
import com.azkz.domain.incomestatement.items.monthly.AbstractMonthlyExtraordinaryIncome
import com.azkz.domain.value.Amount
import java.time.YearMonth

class AbstractMonthlyExtraordinaryIncomeImpl(
    yearMonth: YearMonth,
    breakdowns: List<MonthlyAccountBreakdown>
) : AbstractMonthlyExtraordinaryIncome(yearMonth, breakdowns) {
